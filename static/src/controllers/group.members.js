...
export default class GroupMembersController extends ListViewController {
  ...
  new() {
    ...
    this.$mdDialog.show({
        controller: 'GroupMembersAddDialogController as $ctrl',
  ...
  edit(member, event) {
    ...
    this.$mdDialog.show({
        controller: 'GroupMemberEditDialogController as $ctrl',
