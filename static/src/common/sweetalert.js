/**
 * Based on the swangular module: https://github.com/skeymeulen/swangular
 * Changes:
 *     - renamed to swangular
 *     - imports swal from the sweetalert.js file included with material dashboard template
 */


import swal from '../assets/js/sweetalert2.js';
let SweetAlertModule = angular.module('SweetAlert', [])
    .provider('SweetAlert', function ProvideSweetAlert(){

        return({
            setDefaults: setDefaults,
            $get: ['$compile', '$http', '$rootScope', '$q', '$controller', '$injector', '$templateCache', instantiateSweetAlert]
        });
        ...
        function instantiateSweetAlert($compile, $http, $rootScope, $q, $controller, $injector, $templateCache) {
             ...
             *
             * ex. SweetAlert.alert("This is a warning message");
             *
             */
             ...
             *
             *  ex. SweetAlert.html({title: "Please fill in!",scope: $scope,templateHtml: '/templates/template.html'})
             ...
             *
             * ex. 1: SweetAlert.swal("Good job!", "You clicked the button!", "success")
             *
             * ex. 2: SweetAlert.swal({title: "Auto close alert!", text: "I will close in 2 seconds.", timer: 2000});
             *
             */
...
export default SweetAlertModule;